...
namespace B83.ExpressionParser
{
    ...
    public class ExpressionParser
    {
        ...
        IValue Parse(string aExpression)
        {
            ...
            else if (System.Text.RegularExpressions.Regex.IsMatch(aExpression, @"(?<!E)[\+]"))//  aExpression.Contains('+'))
            {
                string format = @"(?<!E)[\+\-]";
                string[] parts = System.Text.RegularExpressions.Regex.Split(aExpression, format, System.Text.RegularExpressions.RegexOptions.ExplicitCapture);
            ...
            else if (System.Text.RegularExpressions.Regex.IsMatch(aExpression, @"(?<!E)[\-]"))
            {
                string format = @"(?<!E)[\+\-]";
                string[] parts = System.Text.RegularExpressions.Regex.Split(aExpression, format, System.Text.RegularExpressions.RegexOptions.ExplicitCapture);
